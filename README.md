...
| [delegation-orchestration](skills/delegation-orchestration/SKILL.md) | Orchestrator↔subagent contract - model tiering, card-based spawn prompts, evidence-based acceptance, spot-check verification pyramid | Dispatching implementation to subagents, or delegation keeps re-working and burning tokens |
